      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-left mb-16">
          <div className="connexi-gradient-text text-xl mb-6 reveal-on-scroll">
            {lang === 'en' ? '{06} CONTACTS' : '{06} КОНТАКТИ'}
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-8 mb-12 reveal-on-scroll">
            {/* Address */}
            <div className="flex flex-col items-center text-center space-y-4 p-6 rounded-lg bg-white/5 border border-orange-500/20 hover:border-orange-500/40 transition-all">
          ...
          <div className="text-center reveal-on-scroll">
            <Button 
              className="contact-button px-12 py-6 rounded-full transition-all pulse-on-hover font-semibold text-lg mb-8"
            ...
            <div className="flex items-center justify-center gap-6">
              <a 
                ...
                className="flex items-center justify-center w-14 h-14 rounded-full bg-blue-500 hover:bg-blue-600 transition-all hover:scale-110"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center justify-center w-14 h-14 rounded-full bg-green-500 hover:bg-green-600 transition-all hover:scale-110"
              >
                <svg className="w-7 h-7 text-white" viewBox="0 0 24 24" fill="currentColor">
