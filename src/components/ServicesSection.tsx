...
const ServicesSection: React.FC<ServicesSectionProps> = ({ className = "" }) => {
  const services = [
    {
      id: "01",
      title: "РОЗРОБКА І ВПРОВАДЖЕННЯ AI-РІШЕНЬ",
      description: "Проектування, створення і супровід AI-систем для автоматизації та оптимізації бізнес-процесів, аналізу даних і прийняття рішень на базі штучного інтелекту",
    },
    {
      id: "02",
      title: "ІНТЕГРАЦІЯ AI В ІСНУЮЧІ БІЗНЕС-ПРОЦЕСИ",
      description: "Впровадження технологій машинного навчання, комп'ютерного зору та обробки природної мови в існуючі системи підприємства для підвищення їх ефективності та розширення функціоналу",
    },
    {
      id: "03",
      title: "РОЗРОБКА ІНДИВІДУАЛЬНИХ МОДЕЛЕЙ AI",
      description: "Створення, навчання та оптимізація індивідуальних моделей штучного інтелекту під конкретні потреби бізнесу з використанням сучасних технологій та методів машинного навчання",
    }
  ];
